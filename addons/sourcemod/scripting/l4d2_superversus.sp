...
{
	name        = "L4D2 SuperVersus",
	author      = "DDRKhat, Harry, KevonLin",
...
public OnPluginStart()
{
	...
	SurvivorLimit = CreateConVar("l4d_survivor_limit","8","Maximum amount of survivors", CVAR_FLAGS,true,1.00,true,18.00);
	InfectedLimit = CreateConVar("l4d_infected_limit","8","Max amount of infected (will not affect bots)", CVAR_FLAGS,true,1.00,true,18.00);
