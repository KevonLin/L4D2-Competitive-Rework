...
public Plugin myinfo =
{
	...
	author = "Scratchy [Laika] & raziEiL [disawar1] & KevonLin",
...
public void MenuForceAdmHandler(Menu menu, MenuAction action, int admin, int param2)
{
	switch (action)
	{
...
public void MenuTakeAdmHandler(Menu menu, MenuAction action, int admin, int param2)
{
	switch (action)
	{
		case MenuAction_Select:
...
public void MenuForceHandler(Menu menu, MenuAction action, int tank, int param2)
{
	switch (action)
	{
		case MenuAction_Select:
...
public void MenuPassHandler(Menu menu, MenuAction action, int tank, int param2)
{
	switch (action)
	{
		case MenuAction_Select:
...
public void OfferMenuHandler(Menu menu, MenuAction action, int target, int param2)
{
	switch (action)
	{
		case MenuAction_Select:
